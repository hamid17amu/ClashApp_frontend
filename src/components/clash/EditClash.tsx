...
export default function Addclash({token, clash, Open, setOpen}:{token:string, clash:clashData, Open:boolean, setOpen:React.Dispatch<React.SetStateAction<boolean>>}) {
